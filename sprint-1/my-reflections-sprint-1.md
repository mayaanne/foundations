...
## In addition to the challenge specific reflections, answer the following questions in your reflection:
**_What parts of your learning strategy worked? What problems did you face?_**

   The biggest problem that I faced was getting frustrated at one point on Wednesday because i spent three hours trying to figure out a git command, one that should have only taken me about ten minutes. Even after having spent an hour away from the screen, I still returned frustrated. However, once I FINALLY figured it out––let me tell you––I was STOKED. The rest of the time, I really enjoyed the study! It is really invigorating to spend so much time on something and to see what you have created at the end. 

**_How confident are you with each of the Learning Competencies?_**

   I don't feel confident yet. Still as though I am very much standing on shaky ground. I feel like I know a lot more than I did at the start of the week though!

**_Which parts of the work did you enjoy?_**

   I enjoyed the creation aspect of it all. Creating the blog at the end was fun! I also liked being able to navigate the terminal, even if only in a very amateur way. Made me feel like a pretty cool cat, I won't lie. 

**_Which parts of the work did you find tedious?_**

   I only found it tedious when I was frustrated and couldn't solve a problem. The learning aspect of it all is very interesting to me and I enjoy having something to work towards. 
...
**_Did you hear a self critical voice in your head throughout the process of learning during this sprint? What did it say to you? Do you believe what it said?_**
   ...
   Absolutely!! Not all the time, but definitely on Wednesday when I spent so long trying to solve one problem. The voice basically told me that I should know how to do this, in a very unkind way (kind of like _you're an idiot, you literally did this exact step already yesterday_). Once I had resolved the problem, I felt a whole lot better. Good cheese takes time. 